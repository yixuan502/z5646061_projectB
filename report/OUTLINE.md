...
Use `EVIDENCE_GUIDE.md` to locate the validated numbers, figures, caveats, and
interpretation prompts. It is a planning aid only and must not replace the
student-authored Word/PDF report.
